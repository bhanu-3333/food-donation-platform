 ...
 return (
    <div className="fixed inset-0 w-full h-full flex items-center justify-center p-4 overflow-y-auto" style={{ backgroundColor: '#eff5e1' }}>
      <div className="w-full rounded-xl shadow-lg p-6 my-8 transition-all duration-300 hover:shadow-xl animate-fadeIn" style={{ maxWidth: 720, backgroundColor: '#fefff4', borderColor: '#2d3b36', borderWidth: '1px' }}>
        <h2 className="text-2xl font-bold mb-4 text-center" style={{ color: '#2d3b36' }}>Volunteer / NGO Registration</h2>
        
        <div className="space-y-4">
          <div className="animate-slideIn" style={{ animationDelay: '0.1s' }}>
            <label className="block text-sm font-medium mb-1" style={{ color: '#2d3b36' }}>NGO / Committee Name</label>
            <input 
              name="ngoName" 
          ...
          <div className="animate-slideIn" style={{ animationDelay: '0.15s' }}>
            <label className="block text-sm font-medium mb-1" style={{ color: '#2d3b36' }}>Representative Name</label>
            <input 
          ...
          <div className="animate-slideIn" style={{ animationDelay: '0.35s' }}>
            <label className="block text-sm font-medium mb-1" style={{ color: '#2d3b36' }}>NGO Registration ID / Certificate Upload</label>
            <input 
              type="file" 
              accept=".pdf,image/*" 
            ...
            />
            <p className="text-xs mt-1" style={{ color: '#525349' }}>Upload PDF or image (max 5MB)</p>
          </div>

          <div className="animate-slideIn" style={{ animationDelay: '0.4s' }}>
            <label className="block text-sm font-medium mb-1" style={{ color: '#2d3b36' }}>
              Number of Volunteers <span style={{ color: '#525349', fontWeight: 'normal' }}>(optional)</span>
            </label>
            <input 
          ...
          <div className="animate-slideIn" style={{ animationDelay: '0.45s' }}>
            ...
            {coords.lat && (
              <p className="text-sm mt-2 animate-fadeIn" style={{ color: '#525349' }}>
                📍 Location captured: Lat {coords.lat}, Lng {coords.lng}
              </p>
            )}
          </div>
          ...
          <div className="animate-slideIn" style={{ animationDelay: '0.5s' }}>
            <label className="block text-sm font-medium mb-1" style={{ color: '#2d3b36' }}>
              Upload NGO Logo <span style={{ color: '#525349', fontWeight: 'normal' }}>(optional)</span>
            </label>
            <input 
              type="file" 
              accept="image/*" 
